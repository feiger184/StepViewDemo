...
public class HorizontalStepsViewIndicator extends View {
    ...
    private List<Float> mCircleCenterPointPositionList;//所有圆的圆心位置集合
    private Paint mUnCompletedPaint; //未完成的画笔
    private Paint mCompletedPaint;//完成的画笔
    ...
    * */
    private void init() {
        ...
        mUnCompletedPaint.setPathEffect(mEffects);//未完成虚线
        mCompletedPaint.setStyle(Paint.Style.FILL);//完成实线
